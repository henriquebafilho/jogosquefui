    ...
    return (
        <div className='divJogo' style={{
            ...
            <div style={{ display: 'inline', fontSize: '25px', color: Times(props.jogo[0]).letterColor, textShadow: Times(props.jogo[0]).letterColor === "white" ? "0 0 3px #000000, 0 0 3px #000000, 0 0 3px #000000, 0 0 3px #000000, 0 0 3px #000000" : "none", paddingRight: '5px' }}>
                ...
                <img src={require('../escudos/' + Times(props.jogo[0]).escudo + '.png')} title={props.jogo[0]} style={{ display: 'inline-block', verticalAlign: 'middle', width: "4rem", height: "4rem" }} alt={props.jogo[0]} />
            </div>
            <div style={{ display: 'inline-block', textAlign: 'center', textShadow: "0 0 3px #000000, 0 0 3px #000000, 0 0 3px #000000, 0 0 3px #000000, 0 0 3px #000000", color: "white" }}>
                <p style={{ display: 'inline', verticalAlign: 'middle', fontSize: '30px' }}>{props.jogo[2] + ' x ' + props.jogo[3]}</p>
            </div>
            <div style={{ position: 'initial', display: 'inline', fontSize: '25px', color: Times(props.jogo[1]).letterColor, textShadow: Times(props.jogo[1]).letterColor === "white" ? "0 0 3px #000000, 0 0 3px #000000, 0 0 3px #000000, 0 0 3px #000000, 0 0 3px #000000" : "none", paddingLeft: '5px' }}>
                <img src={require('../escudos/' + Times(props.jogo[1]).escudo + '.png')} title={props.jogo[1]} style={{ display: 'inline-block', verticalAlign: 'middle', width: "4rem", height: "4rem" }} alt={props.jogo[1]} />
