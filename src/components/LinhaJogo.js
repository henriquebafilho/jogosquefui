...
function LinhaJogo(props) {
    ...
    return (
        <div className='divJogo' style={{ background: "linear-gradient(90deg, " + Times(props.jogo[0]).backgroundColor + " 49%, " + Times(props.jogo[1]).backgroundColor + " 52%)", padding: '15px', marginBottom: '15px' }}>
