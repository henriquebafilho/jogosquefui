...
class ViewAno extends Component {
    ...
    render() {
        ...
        return (
            this.state.clicked ? <Anos time={time} meusJogos={this.props.meusJogos} /> :
                <div style={{ backgroundColor: Times(this.props.time).backgroundColor, color: Times(this.props.time).letterColor }}>
                    ...
                    <div className="App-header" style={{ backgroundColor: Times(this.props.time).backgroundColor, color: Times(this.props.time).letterColor }}>
                        ...
                        <br />
                        <Estatisticas time={this.state.time} jogos={this.props.jogosAno} />
                        {
                            this.state.jogos.map((index) => {
                                return <LinhaJogo key={JSON.stringify(index)} time={time} jogo={index} meusJogos={this.props.meusJogos} />
                            })
                        }
                    </div>
                </div>
