        ...
        <div className="App-header" style={{ backgroundColor: Times(this.props.meuTime).backgroundColor, color: Times(this.props.meuTime).letterColor }}>
          ...
          {jogos.map((index) => {
            ...
            return <div style={{ width: '100%' }}>
              ...
              <LinhaJogo key={JSON.stringify(index)} meuTime={meuTime} jogo={index} meusJogos={this.props.meusJogos} onSelectAdversario={this.props.onSelectAdversario} disableEstadioClick={true} />
            </div>
          })}
        </div>
      </div>
